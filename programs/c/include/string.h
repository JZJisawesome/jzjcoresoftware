...
int strcmp(const char* lhs, const char* rhs);//TODO string.S
int strncmp(const char* lhs, const char* rhs, size_t count);//TODO String.c
int strcoll(const char* lhs, const char* rhs);//TODO string.S
...
int memcmp(const void* lhs, const void* rhs, size_t count);//TODO string.S
